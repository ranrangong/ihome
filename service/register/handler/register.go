...
func (e *Register) SmsCode(ctx context.Context, req *register.Request, rsp *register.Response) error {
	...
	client, err := sdk.NewClientWithAccessKey("cn-hangzhou", "LTAI4FgbQXjf117SX7E75Rmn", "6icOghQlhjevrTM5PxfiB8nDTxB9z6")
	if err != nil {
		rsp.Errno = utils.RECODE_DATAERR
		rsp.Errmsg = utils.RecodeText(utils.RECODE_DATAERR)
		return err
	...
	request.QueryParams["SignName"] = "爱家租房网"    //签名名称   需要申请
	request.QueryParams["TemplateCode"] = "SMS_183242785"   //模板号   需要申请
